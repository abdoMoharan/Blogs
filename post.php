    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <?php
                $id=$_GET['id'];
                    $select_posts = mysqli_query($conn,"SELECT * FROM new_posts WHERE id='$id'");
                    while ($row_post = mysqli_fetch_assoc($select_posts)) {
                        ?>
                        <div class="post text-center">
                    <div class="image-post"> <img src="./assest/image/new_cate/<?php echo $row_post['image'];?>" class="img-fluid" alt="..."></div>
                    <div class="post-title"> <h4><?php echo $row_post['title'];?></h4> </div>
                    <div class="post-detalis">
                        ...
                        <p class="contents"><?php echo $row_post['message'];?></p>
